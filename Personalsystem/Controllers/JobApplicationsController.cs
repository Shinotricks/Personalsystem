...
namespace Personalsystem.Controllers
{
    public class JobApplicationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,ApplicationText,Published")] JobApplication jobApplication)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,ApplicationText,Published")] JobApplication jobApplication)
        {
            if (ModelState.IsValid)
            {
